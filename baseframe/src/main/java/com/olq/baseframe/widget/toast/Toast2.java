package com.olq.baseframe.widget.toast;
...
public class Toast2 {
    ...
    private Toast2(Context context, String message, int duration) {
    ...
    private Toast2(Context context, int resId, int duration) {
        if(context instanceof Application)
            checkNotification = 0;
        else
            checkNotification = isNotificationEnabled(context) ? 0 : 1;
    ...
    public static Toast2 makeText(Context context, String message, int duration) {
        return new Toast2(context,message,duration);
    }
    public static Toast2 makeText(Context context, int resId, int duration) {
        return new Toast2(context,resId,duration);
    }
