...
object ArithUtils {
     ...
     * @return
     */
    fun retainTwo(d1: Double): String {
     ...
     * @param textView
     */
    fun setTypeface(context: Context, textView: TextView) {
        val typeFace = Typeface.createFromAsset(context.assets, "FZH4FW.TTF")
